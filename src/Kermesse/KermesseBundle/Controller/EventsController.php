...
use Kermesse\KermesseBundle\Entity\Events;
use Kermesse\KermesseBundle\Form\EventsType;
...
class EventsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KermesseBundle:Events')->findAll();

        return $this->render('KermesseBundle:Events:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('KermesseBundle:Events:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KermesseBundle:Events')->find($id);
        ...
        return $this->render('KermesseBundle:Events:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('KermesseBundle:Events:edit.html.twig', array(
            'entity'      => $entity,
